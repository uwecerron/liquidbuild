...
const TOOLS = [
  ...
  },
  {
    ...
    description: 'Creates a quote request for the Liquid Build team, who reply to the person within one business day. Requires a name and a phone number or email.',
    inputSchema: {
      type: 'object',
      properties: {
        name: { type: 'string' },
