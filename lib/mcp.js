...
const TOOLS = [
  ...
  },
  {
    ...
    description: 'The choices Liquid Build uses to take a quote request (project types, starting points, budget bands, timelines, contact preferences). Use these to ask the person short questions before request_quote.',
    inputSchema: { type: 'object', properties: {}, additionalProperties: false },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        description: { type: 'string', description: 'Scope, goals and anything else known, in the person\'s words. Include any ground_project_idea or estimate output you already produced.' },
